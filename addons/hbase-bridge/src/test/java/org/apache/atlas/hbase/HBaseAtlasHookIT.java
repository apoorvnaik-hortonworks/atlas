...
public class HBaseAtlasHookIT {
    ...
    private static final String DGI_URL      = "http://localhost:31000/";
    ...
    private static void createAtlasClient() {
        try {
            ...
            LOG.info("Unable to create AtlasClient for Testing ");
            e.printStackTrace();
    ...
    private static void createHBaseCluster() throws Exception {
    ...
    private String assertNameSpaceIsRegistered(String nameSpace) throws Exception {
        ...
        return assertEntityIsRegistered(HBaseDataTypes.HBASE_NAMESPACE.getName(), AtlasClient.REFERENCEABLE_ATTRIBUTE_NAME, nameSpaceQualifiedName);
    }

    private String assertTableIsRegistered(String nameSpace, String tableName) throws Exception {
        if (LOG.isDebugEnabled()) {
     ...
     */
    private void waitFor(int timeout, HBaseAtlasHookIT.Predicate predicate) throws Exception {
