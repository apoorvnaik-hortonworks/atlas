...
public abstract class AtlasBaseClient {
    ...
    private static final APIInfo IMPORT = new APIInfo(BASE_URI + ADMIN_IMPORT, HttpMethod.POST, Response.Status.OK, MediaType.MULTIPART_FORM_DATA, MediaType.APPLICATION_JSON);
    ...
    protected <T> T callAPIWithResource(APIInfo api, WebResource resource, Object requestObject, GenericType<T> responseType) throws AtlasServiceException {
        ...
        do {
            if (LOG.isDebugEnabled()) {
                LOG.debug("Call         : {} {}", api.getMethod(), api.getPath());
    ...
    public static class APIInfo {
        ...
        public APIInfo(String path, String method, Response.Status status, String consumes, String produces) {
            this.path = path;
            this.method = method;
            this.status = status;
