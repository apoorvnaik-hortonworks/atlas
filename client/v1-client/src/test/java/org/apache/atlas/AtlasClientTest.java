...
public class AtlasClientTest {
    ...
    public void shouldVerifyServerIsReady() throws AtlasServiceException {
        ...
        when(builder.method(AtlasClient.API_V1.VERSION.getApi().getMethod(), ClientResponse.class, null)).thenReturn(response);
    ...
    private WebResource.Builder setupBuilder(AtlasClient.API_V1 api, WebResource webResource) {
        when(webResource.path(api.getApi().getPath())).thenReturn(service);
    ...
    public void shouldReturnFalseIfServerIsNotReady() throws AtlasServiceException {
        ...
        AtlasClient atlasClient = new AtlasClient(service, configuration);
        WebResource.Builder builder = setupBuilder(AtlasClient.API_V1.VERSION, service);
        when(builder.method(AtlasClient.API_V1.VERSION.getApi().getMethod(), ClientResponse.class, null)).thenThrow(
    ...
    public void shouldGetAdminStatus() throws AtlasServiceException {
        ...
        when(builder.method(AtlasClient.API_V1.STATUS.getApi().getMethod(), ClientResponse.class, null)).thenReturn(response);
...
//        atlasClient.setService();
    ...
    public void shouldSelectActiveAmongMultipleServersIfHAIsEnabled() {
        ...
        when(builder.method(AtlasClient.API_V1.STATUS.getApi().getMethod(), ClientResponse.class, null)).
    ...
    public void shouldRetryAPICallsOnClientHandlerException() throws AtlasServiceException, URISyntaxException {
        ...
        when(builder.method(AtlasClient.API_V1.LIST_TYPES.getApi().getMethod(), ClientResponse.class, null)).
        ...
        atlasClient.callAPIWithRetries(AtlasClient.API_V1.LIST_TYPES.getApi(), null, resourceCreator);
