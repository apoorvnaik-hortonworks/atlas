...
public class AtlasClientV2 extends AtlasBaseClient {
    ...
    public AtlasTypesDef getAllTypeDefs(SearchFilter searchFilter) throws AtlasServiceException {
        return callAPI(API_V2.GET_ALL_TYPE_DEFS.getApi(), AtlasTypesDef.class, searchFilter.getParams());
    }

    public boolean typeWithGuidExists(String guid) {
        try {
            callAPI(API_V2.GET_TYPEDEF_BY_GUID.getApi(), String.class, null, guid);
    ...
    public boolean typeWithNameExists(String name) {
        try {
            callAPI(API_V2.GET_TYPEDEF_BY_NAME.getApi(), String.class, null, name);
        } catch (AtlasServiceException e) {
            return false;
        }
        return true;
    ...
    public AtlasTypesDef createAtlasTypeDefs(final AtlasTypesDef typesDef) throws AtlasServiceException {
        return callAPI(API_V2.CREATE_ALL_TYPE_DEFS.getApi(), AtlasTypesDef.class, AtlasType.toJson(typesDef));
    }
    ...
    public AtlasTypesDef updateAtlasTypeDefs(final AtlasTypesDef typesDef) throws AtlasServiceException {
        return callAPI(API_V2.UPDATE_ALL_TYPE_DEFS.getApi(), AtlasTypesDef.class, AtlasType.toJson(typesDef));
    }
    ...
    public void deleteAtlasTypeDefs(final AtlasTypesDef typesDef) throws AtlasServiceException {
        callAPI(API_V2.DELETE_ALL_TYPE_DEFS.getApi(), (Class<?>)null, AtlasType.toJson(typesDef));
    }
    ...
    public AtlasLineageInfo getLineageInfo(final String guid, final LineageDirection direction, final int depth) throws AtlasServiceException {
        ...
        return callAPI(API_V2.LINEAGE_INFO.getApi(), AtlasLineageInfo.class, queryParams, guid);
    }

    public AtlasEntityWithExtInfo getEntityByGuid(String guid) throws AtlasServiceException {
        return callAPI(API_V2.GET_ENTITY_BY_GUID.getApi(), AtlasEntityWithExtInfo.class, (MultivaluedMap<String, String>) null, guid);
    }
    ...
    public AtlasEntityWithExtInfo getEntityByAttribute(String type, Map<String, String> attributes) throws AtlasServiceException {
        ...
        return callAPI(API_V2.GET_ENTITY_BY_ATTRIBUTE.getApi(), AtlasEntityWithExtInfo.class, queryParams, type);
    }
    ...
    public EntityMutationResponse updateEntityByAttribute(String type, Map<String, String> attributes, AtlasEntityWithExtInfo entityInfo)
        ...
        return callAPI(API_V2.UPDATE_ENTITY_BY_ATTRIBUTE.getApi(), EntityMutationResponse.class, entityInfo, queryParams, type);
    }
    ...
    public EntityMutationResponse deleteEntityByAttribute(String type, Map<String, String> attributes) throws AtlasServiceException {
        ...
        return callAPI(API_V2.DELETE_ENTITY_BY_ATTRIBUTE.getApi(), EntityMutationResponse.class, queryParams, type);
    }

    /* Entity Calls */

    public EntityMutationResponse createEntity(AtlasEntityWithExtInfo entity) throws AtlasServiceException {
        return callAPI(API_V2.CREATE_ENTITY.getApi(), EntityMutationResponse.class, entity);
    }

    public EntityMutationResponse updateEntity(AtlasEntityWithExtInfo entity) throws AtlasServiceException {
        return callAPI(API_V2.UPDATE_ENTITY.getApi(), EntityMutationResponse.class, entity);
    }

    public EntityMutationResponse deleteEntityByGuid(String guid) throws AtlasServiceException {
        return callAPI(API_V2.DELETE_ENTITY_BY_GUID.getApi(), EntityMutationResponse.class, null, guid);
    }
    ...
    public AtlasEntitiesWithExtInfo getEntitiesByGuids(List<String> guids) throws AtlasServiceException {
        ...
        return callAPI(API_V2.GET_ENTITIES_BY_GUIDS.getApi(), AtlasEntitiesWithExtInfo.class, queryParams);
    }

    public EntityMutationResponse createEntities(AtlasEntitiesWithExtInfo atlasEntities) throws AtlasServiceException {
        return callAPI(API_V2.CREATE_ENTITIES.getApi(), EntityMutationResponse.class, atlasEntities);
    }

    public EntityMutationResponse updateEntities(AtlasEntitiesWithExtInfo atlasEntities) throws AtlasServiceException {
        return callAPI(API_V2.UPDATE_ENTITIES.getApi(), EntityMutationResponse.class, atlasEntities);
    }

    public EntityMutationResponse deleteEntitiesByGuids(List<String> guids) throws AtlasServiceException {
        return callAPI(API_V2.DELETE_ENTITIES_BY_GUIDS.getApi(), EntityMutationResponse.class, "guid", guids);
    }

    public AtlasClassifications getClassifications(String guid) throws AtlasServiceException {
        return callAPI(formatPathParameters(API_V2.GET_CLASSIFICATIONS.getApi(), guid), AtlasClassifications.class, null);
    }

    public void addClassifications(String guid, List<AtlasClassification> classifications) throws AtlasServiceException {
        callAPI(formatPathParameters(API_V2.ADD_CLASSIFICATIONS.getApi(), guid), (Class<?>)null, classifications, (String[]) null);
    }

    public void updateClassifications(String guid, List<AtlasClassification> classifications) throws AtlasServiceException {
        callAPI(formatPathParameters(API_V2.UPDATE_CLASSIFICATIONS.getApi(), guid), AtlasClassifications.class, classifications);
    }

    public void deleteClassifications(String guid, List<AtlasClassification> classifications) throws AtlasServiceException {
        callAPI(formatPathParameters(API_V2.GET_CLASSIFICATIONS.getApi(), guid), AtlasClassifications.class, classifications);
    }

    public void deleteClassification(String guid, String classificationName) throws AtlasServiceException {
        callAPI(formatPathParameters(API_V2.DELETE_CLASSIFICATION.getApi(), guid, classificationName), null, null);
    }
    ...
    public AtlasSearchResult dslSearch(final String query) throws AtlasServiceException {
        ...
        return callAPI(API_V2.DSL_SEARCH.getApi(), AtlasSearchResult.class, queryParams);
    }
    ...
    public AtlasSearchResult fullTextSearch(final String query) throws AtlasServiceException {
        ...
        return callAPI(API_V2.FULL_TEXT_SEARCH.getApi(), AtlasSearchResult.class, queryParams);
    }
    ...
    public AtlasSearchResult basicSearch(final String typeName, final String classification, final String query,
        ...
        return callAPI(API_V2.BASIC_SEARCH.getApi(), AtlasSearchResult.class, queryParams);
    }

    public AtlasSearchResult facetedSearch(SearchParameters searchParameters) throws AtlasServiceException {
        return callAPI(API_V2.FACETED_SEARCH.getApi(), AtlasSearchResult.class, searchParameters);
    }

    @Override
    protected API getStatusAPI() {
        return new API(BASE_URI + ADMIN_STATUS, HttpMethod.GET, Response.Status.OK);
    }

    @Override
    protected API getVersionAPI() {
        return new API(BASE_URI + ADMIN_VERSION, HttpMethod.GET, Response.Status.OK);
    }

    @Override
    protected API getMetricsAPI() {
        return new API(BASE_URI + ADMIN_METRICS, HttpMethod.GET, Response.Status.OK);
    }
    ...
    public enum API_V2 {
        GET_TYPEDEF_BY_NAME(TYPEDEF_BY_NAME, HttpMethod.GET, Response.Status.OK),
        GET_TYPEDEF_BY_GUID(TYPEDEF_BY_GUID, HttpMethod.GET, Response.Status.OK),
        GET_ALL_TYPE_DEFS(TYPEDEFS_API, HttpMethod.GET, Response.Status.OK),
        CREATE_ALL_TYPE_DEFS(TYPEDEFS_API, HttpMethod.POST, Response.Status.OK),
        UPDATE_ALL_TYPE_DEFS(TYPEDEFS_API, HttpMethod.PUT, Response.Status.OK),
        DELETE_ALL_TYPE_DEFS(TYPEDEFS_API, HttpMethod.DELETE, Response.Status.NO_CONTENT),
        GET_ENTITY_BY_GUID(ENTITY_API + "guid/", HttpMethod.GET, Response.Status.OK),
        GET_ENTITY_BY_ATTRIBUTE(ENTITY_API + "uniqueAttribute/type/", HttpMethod.GET, Response.Status.OK),
        CREATE_ENTITY(ENTITY_API, HttpMethod.POST, Response.Status.OK),
        UPDATE_ENTITY(ENTITY_API, HttpMethod.POST, Response.Status.OK),
        UPDATE_ENTITY_BY_ATTRIBUTE(ENTITY_API + "uniqueAttribute/type/", HttpMethod.PUT, Response.Status.OK),
        DELETE_ENTITY_BY_GUID(ENTITY_API + "guid/", HttpMethod.DELETE, Response.Status.OK),
        DELETE_ENTITY_BY_ATTRIBUTE(ENTITY_API + "uniqueAttribute/type/", HttpMethod.DELETE, Response.Status.OK),
        GET_ENTITIES_BY_GUIDS(ENTITY_BULK_API, HttpMethod.GET, Response.Status.OK),
        CREATE_ENTITIES(ENTITY_BULK_API, HttpMethod.POST, Response.Status.OK),
        UPDATE_ENTITIES(ENTITY_BULK_API, HttpMethod.POST, Response.Status.OK),
        DELETE_ENTITIES_BY_GUIDS(ENTITY_BULK_API, HttpMethod.DELETE, Response.Status.OK),
        GET_CLASSIFICATIONS(ENTITY_API + "guid/%s/classifications", HttpMethod.GET, Response.Status.OK),
        ADD_CLASSIFICATIONS(ENTITY_API + "guid/%s/classifications", HttpMethod.POST, Response.Status.NO_CONTENT),
        UPDATE_CLASSIFICATIONS(ENTITY_API + "guid/%s/classifications", HttpMethod.PUT, Response.Status.OK),
        DELETE_CLASSIFICATION(ENTITY_API + "guid/%s/classification/%s", HttpMethod.DELETE, Response.Status.NO_CONTENT),
        LINEAGE_INFO(LINEAGE_URI, HttpMethod.GET, Response.Status.OK),
        DSL_SEARCH(DSL_URI, HttpMethod.GET, Response.Status.OK),
        FULL_TEXT_SEARCH(FULL_TEXT_URI, HttpMethod.GET, Response.Status.OK),
        BASIC_SEARCH(BASIC_SEARCH_URI, HttpMethod.GET, Response.Status.OK),
        FACETED_SEARCH(FACETED_SEARCH_URI, HttpMethod.POST, Response.Status.OK);

        private final API api;

        API_V2(String path, String method, Response.Status status) {
            api = new API(path, method, status);
        }
